CREATE TABLE regions (
    [region_id] INT,
    [region_name] NVARCHAR(22)
);
INSERT INTO regions VALUES (1,N'Europe'),
	(2,N'Americas'),
	(3,N'Asia'),
...
CREATE TABLE countries (
    ...
    [country_name] NVARCHAR(24),
    [region_id] INT
);
INSERT INTO countries VALUES (N'AR',N'Argentina',2),
	(N'AU',N'Australia',3),
	(N'BE',N'Belgium',1),
	(N'BR',N'Brazil',2),
	(N'CA',N'Canada',2),
...
INSERT INTO departments VALUES (10,N'Administration',200,1700),
...
IF NOT EXISTS (
    ...
    [job_id] NVARCHAR(10),
    [job_title] NVARCHAR(31),
    [min_salary] INT,
    [max_salary] INT
);
INSERT INTO jobs VALUES (N'AD_PRES',N'President',20000,40000),
...
IF NOT EXISTS (
    select * from sysobjects where name='job_history' and xtype='U'
...
INSERT INTO job_history VALUES (201,'2004-02-17 00:00:00','2007-12-19 00:00:00',N'MK_REP',20),
	(200,'2002-07-01 00:00:00','2006-12-31 00:00:00',N'AC_ACCOUNT',90),
	(200,'1995-09-17 00:00:00','2001-06-17 00:00:00',N'AD_ASST',90),
	(176,'2007-01-01 00:00:00','2007-12-31 00:00:00',N'SA_MAN',80),
	(176,'2006-03-24 00:00:00','2006-12-31 00:00:00',N'SA_REP',80),
	(122,'2007-01-01 00:00:00','2007-12-31 00:00:00',N'ST_CLERK',50),
	(114,'2006-03-24 00:00:00','2007-12-31 00:00:00',N'ST_CLERK',50),
	(102,'2001-01-13 00:00:00','2006-07-24 00:00:00',N'IT_PROG',60),
	(101,'2001-10-28 00:00:00','2005-03-15 00:00:00',N'AC_MGR',110),
	(101,'1997-09-21 00:00:00','2001-10-27 00:00:00',N'AC_ACCOUNT',110);
...
IF NOT EXISTS (
    select * from sysobjects where name='job_grade' and xtype='U'
) CREATE TABLE job_grade (
    [grade_level] NVARCHAR(1),
    [lowest_sal] INT,
    [highest_sal] INT
);
INSERT INTO job_grade VALUES (N'A',1000,2999),
	(N'B',3000,5999),
	(N'C',6000,9999),
	(N'D',10000,14999),
	(N'E',15000,24999),
